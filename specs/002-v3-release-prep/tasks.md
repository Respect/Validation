...
- [ ] T010 [P] [US1] Validate migration guide structure against template in docs/11-migration-from-2x.md
- [ ] T011 [P] [US1] Test all side-by-side examples in migration guide compile for both v2.4 and v3.0

### Implementation for User Story 1

- [ ] T012 [P] [US1] Update migration guide metadata (dates, version) in docs/11-migration-from-2x.md
...
- [ ] T027 [P] [US2] Validate rule catalog completeness in docs/09-list-of-rules-by-category.md
...
- [ ] T053 [P] [US2] Remove deleted rules from docs/09-list-of-rules-by-category.md
- [ ] T054 [P] [US2] Add new rules to docs/09-list-of-rules-by-category.md
- [ ] T055 [P] [US2] Add "Prefixes" category to docs/09-list-of-rules-by-category.md
- [ ] T056 [P] [US2] Mark deprecated rules with clear notes in docs/09-list-of-rules-by-category.md
...
- [ ] T061 [P] [US2] Create documentation for new prefix rules in docs/rules/
- [ ] T062 [P] [US2] Update all examples in rule docs to use v:: facade
...
- [ ] T068 [P] [US3] Update exception type/hierarchy documentation in docs/03-handling-exceptions.md
- [ ] T069 [P] [US3] Document placeholder conversion behaviors for different locales in docs/05-message-placeholder-conversion.md
- [ ] T070 [P] [US3] Update message rendering/translation documentation in docs/04-message-translation.md
- [ ] T071 [P] [US3] Document placeholder behaviors and formatting changes in docs/04-message-translation.md
