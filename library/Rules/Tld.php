...
final class Tld extends AbstractRule
{
    ...
    private const TLD_LIST = [
        ...
        'CYMRU', 'CYOU', 'CZ', 'DAD', 'DANCE', 'DATA', 'DATE', 'DATING',
        ...
        'EDU', 'EDUCATION', 'EE', 'EG', 'EMAIL', 'EMERCK', 'ENERGY',
        ...
        'GODADDY', 'GOLD', 'GOLDPOINT', 'GOLF', 'GOODYEAR', 'GOOG', 'GOOGLE',
        'GOP', 'GOT', 'GOV', 'GP', 'GQ', 'GR', 'GRAINGER', 'GRAPHICS',
        'GRATIS', 'GREEN', 'GRIPE', 'GROCERY', 'GROUP', 'GS', 'GT', 'GU',
        'GUCCI', 'GUGE', 'GUIDE', 'GUITARS', 'GURU', 'GW', 'GY', 'HAIR',
        ...
        'KH', 'KI', 'KIA', 'KIDS', 'KIM', 'KINDLE', 'KITCHEN', 'KIWI', 'KM',
        'KN', 'KOELN', 'KOMATSU', 'KOSHER', 'KP', 'KPMG', 'KPN', 'KR', 'KRD',
        ...
        'LILLY', 'LIMITED', 'LIMO', 'LINCOLN', 'LINK', 'LIVE', 'LIVING', 'LK',
        ...
        'MU', 'MUSEUM', 'MUSIC', 'MV', 'MW', 'MX', 'MY', 'MZ', 'NA', 'NAB',
        'NAGOYA', 'NAME', 'NAVY', 'NBA', 'NC', 'NE', 'NEC', 'NET', 'NETBANK',
        'NETFLIX', 'NETWORK', 'NEUSTAR', 'NEW', 'NEWS', 'NEXT', 'NEXTDIRECT',
        'NEXUS', 'NF', 'NFL', 'NG', 'NGO', 'NHK', 'NI', 'NICO', 'NIKE',
        'NIKON', 'NINJA', 'NISSAN', 'NISSAY', 'NL', 'NO', 'NOKIA', 'NORTON',
        'NOW', 'NOWRUZ', 'NOWTV', 'NP', 'NR', 'NRA', 'NRW', 'NTT', 'NU', 'NYC',
        'NZ', 'OBI', 'OBSERVER', 'OFFICE', 'OKINAWA', 'OLAYAN', 'OLAYANGROUP',
        ...
        'RICOH', 'RIL', 'RIO', 'RIP', 'RO', 'ROCKS', 'RODEO', 'ROGERS', 'ROOM',
        ...
        'WME', 'WOODSIDE', 'WORK', 'WORKS', 'WORLD', 'WOW', 'WS', 'WTC', 'WTF',
        'XBOX', 'XEROX', 'XIHUAN', 'XIN', 'XN--11B4C3D', 'XN--1CK2E1B',
