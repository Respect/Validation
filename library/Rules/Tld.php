...
final class Tld extends AbstractRule
{
    ...
    private const TLD_LIST = [
        ...
        'MU', 'MUSEUM', 'MUSIC', 'MUTUAL', 'MV', 'MW', 'MX', 'MY', 'MZ', 'NA',
        'NAB', 'NAGOYA', 'NAME', 'NATURA', 'NAVY', 'NBA', 'NC', 'NE', 'NEC',
