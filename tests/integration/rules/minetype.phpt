...
?>
--EXPECTF--
"image.png" must have "image/png" mimetype
"tests/fixtures/valid-image.png" must not have "image/png" mimetype
- "tests/fixtures/invalid-image.png" must have "image/png" mimetype
- "tests/fixtures/valid-image.png" must not have "image/png" mimetype
