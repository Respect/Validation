 ...
 * @since 1.0.0
 */
final class KeyNestedTest extends RuleTestCase2
{
    /**
     * @return array
     */
    public function providerForValidInput(): array
    {
        ...
        return [
            ...
            [new KeyNested('bar.foo.'), $input1],
            [new KeyNested('bar.foo.baz', $this->createRuleMock(true, 'hello world!')), $input1],
            [new KeyNested(0, $this->createRuleMock(true, 'Zero!')), $input2],
            [new KeyNested('empty-key'), $input3],
            [new KeyNested('empty-key.nothing', $this->createRuleMock(false, null), false), $input3],
