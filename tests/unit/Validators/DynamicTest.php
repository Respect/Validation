...
final class DynamicTest extends TestCase
{
    ...
    public function itShouldThrowAnExceptionWhenRuleCreatorDoesNotReturnRule(): void
    {
        ...
        $validator = new Dynamic(static fn() => null);

        $this->expectException(ComponentException::class);
        $this->expectExceptionMessage('Dynamic failed because it could not create the rule');
    ...
    {
        self::assertInvalidInput(new Dynamic(static fn($creatorInput) => Stub::fail(1)), $input);
    }
    ...
    {
        self::assertValidInput(new Dynamic(static fn($creatorInput) => Stub::pass(1)), $input);
    }
    ...
    public function itShouldReturnTheResultFromTheCreatedRule(mixed $input): void
    {
        ...
        $validator = new Dynamic(static fn($creatorInput) => Stub::fail(1));
