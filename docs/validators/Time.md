...
// → `DateTime { 2026-01-06T13:02:25+00:00 }` must be a valid time in the format "23:59:59"

v::time()->assert(new DateTimeImmutable());
// → `DateTimeImmutable { 2026-01-06T13:02:25+00:00 }` must be a valid time in the format "23:59:59"
```
