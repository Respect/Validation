...
| IsoCodesBench            | currencyCode      |                    | 5    | 10  | 2.965mb  | 5.747μs   | ±2.96% |
| IsoCodesBench            | languageCode      |                    | 5    | 10  | 10.046mb | 5.989μs   | ±2.16% |
| IsoCodesBench            | phone             |                    | 5    | 10  | 4.163mb  | 40.052μs  | ±0.92% |
...
| ValidatorBench           | evaluate          | Domain             | 5    | 10  | 2.372mb  | 29.833μs  | ±1.49% |
| ValidatorBench           | evaluate          | Each               | 5    | 10  | 2.064mb  | 6.948μs   | ±3.81% |
| ValidatorBench           | evaluate          | Email              | 5    | 10  | 2.243mb  | 27.724μs  | ±2.29% |
...
| ValidatorBench           | evaluate          | Image              | 5    | 10  | 9.849mb  | 184.257μs | ±1.88% |
...
| ValidatorBench           | evaluate          | KeySet             | 5    | 10  | 2.065mb  | 6.745μs   | ±2.74% |
...
| ValidatorBench           | evaluate          | Mimetype           | 5    | 10  | 9.850mb  | 200.025μs | ±1.41% |
...
| ValidatorBench           | evaluate          | NoneOf             | 5    | 10  | 2.064mb  | 4.600μs   | ±1.31% |
...
| ValidatorBench           | evaluate          | Phone              | 5    | 10  | 3.264mb  | 43.145μs  | ±1.37% |
...
| ValidatorBench           | evaluate          | Size               | 5    | 10  | 2.065mb  | 10.209μs  | ±1.85% |
...
| ValidatorBench           | evaluate          | Url                | 5    | 10  | 2.506mb  | 53.718μs  | ±3.15% |
...
| PrefixBench              | prefixTransformer | 0                  | 100  | 10  | 2.064mb  | 0.821μs   | ±1.05% |
| PrefixBench              | prefixTransformer | 1                  | 100  | 10  | 2.064mb  | 0.832μs   | ±1.55% |
| PrefixBench              | prefixTransformer | 2                  | 100  | 10  | 2.064mb  | 0.740μs   | ±1.92% |
| PrefixBench              | prefixTransformer | 3                  | 100  | 10  | 2.064mb  | 0.100μs   | ±0.00% |
| PrefixBench              | prefixTransformer | 4                  | 100  | 10  | 2.064mb  | 0.250μs   | ±1.93% |
| CompositeValidatorsBench | isValidGrouped    | allOf(10)          | 50   | 5   | 2.725mb  | 4.666μs   | ±4.05% |
| CompositeValidatorsBench | isValidGrouped    | oneOf(10)          | 50   | 5   | 2.727mb  | 5.263μs   | ±7.83% |
| CompositeValidatorsBench | isValidGrouped    | anyOf(10)          | 50   | 5   | 2.724mb  | 4.331μs   | ±0.54% |
| CompositeValidatorsBench | isValidGrouped    | noneOf(10)         | 50   | 5   | 2.723mb  | 3.856μs   | ±5.07% |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(10)   | 50   | 5   | 2.714mb  | 4.820μs   | ±4.21% |
| CompositeValidatorsBench | isValidGrouped    | allOf(100)         | 50   | 5   | 2.769mb  | 5.910μs   | ±2.78% |
| CompositeValidatorsBench | isValidGrouped    | oneOf(100)         | 50   | 5   | 2.771mb  | 6.908μs   | ±3.57% |
| CompositeValidatorsBench | isValidGrouped    | anyOf(100)         | 50   | 5   | 2.768mb  | 5.557μs   | ±4.27% |
| CompositeValidatorsBench | isValidGrouped    | noneOf(100)        | 50   | 5   | 2.767mb  | 5.053μs   | ±2.99% |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(100)  | 50   | 5   | 2.758mb  | 5.733μs   | ±2.65% |
| CompositeValidatorsBench | isValidArrayBased | all(10)            | 50   | 5   | 2.727mb  | 12.783μs  | ±2.62% |
| CompositeValidatorsBench | isValidArrayBased | each(10)           | 50   | 5   | 2.728mb  | 23.287μs  | ±3.19% |
| CompositeValidatorsBench | isValidArrayBased | all(100)           | 50   | 5   | 2.771mb  | 77.670μs  | ±1.37% |
| CompositeValidatorsBench | isValidArrayBased | each(100)          | 50   | 5   | 2.772mb  | 179.968μs | ±0.93% |
| CompositeValidatorsBench | isValidDomain     | no dots            | 50   | 5   | 2.877mb  | 7.302μs   | ±4.84% |
| CompositeValidatorsBench | isValidDomain     | starts with "-"    | 50   | 5   | 2.877mb  | 6.677μs   | ±1.08% |
| CompositeValidatorsBench | isValidDomain     | ends with "-"      | 50   | 5   | 2.877mb  | 7.048μs   | ±3.12% |
| CompositeValidatorsBench | isValidDomain     | double "--"        | 50   | 5   | 2.877mb  | 6.669μs   | ±4.03% |
