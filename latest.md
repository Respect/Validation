...
|--------------------------|-------------------|--------------------|------|-----|----------|-----------|--------|
| ValidatorBench           | evaluate          | After              | 5    | 10  | 2.087mb  | 4.000μs   | ±2.02% |
| ValidatorBench           | evaluate          | All                | 5    | 10  | 2.087mb  | 4.400μs   | ±1.37% |
| ValidatorBench           | evaluate          | AllOf              | 5    | 10  | 2.087mb  | 3.001μs   | ±3.18% |
...
| ValidatorBench           | evaluate          | Date               | 5    | 10  | 2.087mb  | 4.201μs   | ±2.29% |
...
| ValidatorBench           | evaluate          | Domain             | 5    | 10  | 2.354mb  | 20.699μs  | ±2.09% |
| ValidatorBench           | evaluate          | Each               | 5    | 10  | 2.087mb  | 4.999μs   | ±1.99% |
| ValidatorBench           | evaluate          | EachKey            | 5    | 10  | 2.087mb  | 7.801μs   | ±1.24% |
| ValidatorBench           | evaluate          | Email              | 5    | 10  | 2.265mb  | 18.369μs  | ±0.97% |
...
| ValidatorBench           | evaluate          | Formatted          | 5    | 10  | 2.088mb  | 3.800μs   | ±2.37% |
...
| ValidatorBench           | evaluate          | Image              | 5    | 10  | 9.865mb  | 159.845μs | ±1.26% |
...
| ValidatorBench           | evaluate          | Min                | 5    | 10  | 2.087mb  | 3.800μs   | ±1.59% |
| ValidatorBench           | evaluate          | Mimetype           | 5    | 10  | 9.867mb  | 161.820μs | ±2.45% |
...
| ValidatorBench           | evaluate          | Phone              | 5    | 10  | 2.896mb  | 28.800μs  | ±1.41% |
...
| ValidatorBench           | evaluate          | Size               | 5    | 10  | 2.090mb  | 7.200μs   | ±1.50% |
...
| ValidatorBench           | evaluate          | Trimmed            | 5    | 10  | 2.090mb  | 10.199μs  | ±1.75% |
...
| ValidatorBench           | evaluate          | Url                | 5    | 10  | 2.535mb  | 36.076μs  | ±1.99% |
| ValidatorBench           | evaluate          | Uuid               | 5    | 10  | 2.597mb  | 5.584μs   | ±3.48% |
...
| CompositeValidatorsBench | isValidGrouped    | allOf(10)          | 50   | 5   | 2.471mb  | 5.183μs   | ±2.97% |
| CompositeValidatorsBench | isValidGrouped    | oneOf(10)          | 50   | 5   | 2.474mb  | 7.062μs   | ±3.84% |
| CompositeValidatorsBench | isValidGrouped    | anyOf(10)          | 50   | 5   | 2.470mb  | 6.276μs   | ±3.07% |
| CompositeValidatorsBench | isValidGrouped    | noneOf(10)         | 50   | 5   | 2.470mb  | 5.892μs   | ±1.20% |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(10)   | 50   | 5   | 2.460mb  | 6.203μs   | ±2.30% |
| CompositeValidatorsBench | isValidGrouped    | allOf(100)         | 50   | 5   | 2.515mb  | 8.774μs   | ±1.02% |
| CompositeValidatorsBench | isValidGrouped    | oneOf(100)         | 50   | 5   | 2.518mb  | 10.733μs  | ±2.67% |
| CompositeValidatorsBench | isValidGrouped    | anyOf(100)         | 50   | 5   | 2.514mb  | 9.882μs   | ±5.05% |
| CompositeValidatorsBench | isValidGrouped    | noneOf(100)        | 50   | 5   | 2.514mb  | 9.453μs   | ±1.22% |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(100)  | 50   | 5   | 2.504mb  | 9.616μs   | ±0.75% |
| CompositeValidatorsBench | isValidArrayBased | all(10)            | 50   | 5   | 2.475mb  | 10.566μs  | ±6.13% |
| CompositeValidatorsBench | isValidArrayBased | each(10)           | 50   | 5   | 2.475mb  | 18.806μs  | ±0.93% |
| CompositeValidatorsBench | isValidArrayBased | all(100)           | 50   | 5   | 2.519mb  | 56.649μs  | ±1.43% |
| CompositeValidatorsBench | isValidArrayBased | each(100)          | 50   | 5   | 2.519mb  | 133.007μs | ±0.85% |
| CompositeValidatorsBench | isValidDomain     | no dots            | 50   | 5   | 2.630mb  | 7.589μs   | ±7.55% |
| CompositeValidatorsBench | isValidDomain     | starts with "-"    | 50   | 5   | 2.630mb  | 7.548μs   | ±3.83% |
| CompositeValidatorsBench | isValidDomain     | ends with "-"      | 50   | 5   | 2.630mb  | 7.672μs   | ±1.47% |
| CompositeValidatorsBench | isValidDomain     | double "--"        | 50   | 5   | 2.630mb  | 7.633μs   | ±1.47% |
| IsoCodesBench            | subdivisionCode   |                    | 5    | 10  | 7.752mb  | 11.822μs  | ±2.04% |
| IsoCodesBench            | countryCode       |                    | 5    | 10  | 2.838mb  | 9.383μs   | ±1.43% |
| IsoCodesBench            | currencyCode      |                    | 5    | 10  | 2.705mb  | 9.190μs   | ±1.47% |
| IsoCodesBench            | languageCode      |                    | 5    | 10  | 9.785mb  | 10.845μs  | ±2.05% |
| IsoCodesBench            | phone             |                    | 5    | 10  | 3.774mb  | 36.099μs  | ±1.30% |
| PrefixBench              | prefixTransformer | 0                  | 100  | 10  | 2.087mb  | 0.660μs   | ±0.00% |
| PrefixBench              | prefixTransformer | 1                  | 100  | 10  | 2.087mb  | 0.656μs   | ±2.09% |
| PrefixBench              | prefixTransformer | 2                  | 100  | 10  | 2.087mb  | 0.593μs   | ±2.47% |
| PrefixBench              | prefixTransformer | 3                  | 100  | 10  | 2.087mb  | 0.080μs   | ±0.00% |
| PrefixBench              | prefixTransformer | 4                  | 100  | 10  | 2.087mb  | 0.190μs   | ±1.57% |
