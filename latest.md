...
|--------------------------|-------------------|--------------------|------|-----|----------|-----------|---------|
| PrefixBench              | prefixTransformer | 0                  | 100  | 10  | 2.088mb  | 0.668μs   | ±2.65%  |
| PrefixBench              | prefixTransformer | 1                  | 100  | 10  | 2.088mb  | 0.664μs   | ±2.39%  |
| PrefixBench              | prefixTransformer | 2                  | 100  | 10  | 2.088mb  | 0.656μs   | ±2.43%  |
| PrefixBench              | prefixTransformer | 3                  | 100  | 10  | 2.087mb  | 0.080μs   | ±0.00%  |
| PrefixBench              | prefixTransformer | 4                  | 100  | 10  | 2.087mb  | 0.200μs   | ±1.51%  |
| IsoCodesBench            | subdivisionCode   |                    | 5    | 10  | 7.752mb  | 12.582μs  | ±2.23%  |
| IsoCodesBench            | countryCode       |                    | 5    | 10  | 2.838mb  | 9.655μs   | ±1.89%  |
| IsoCodesBench            | currencyCode      |                    | 5    | 10  | 2.705mb  | 9.216μs   | ±1.98%  |
| IsoCodesBench            | languageCode      |                    | 5    | 10  | 9.785mb  | 12.018μs  | ±3.24%  |
| IsoCodesBench            | phone             |                    | 5    | 10  | 3.774mb  | 36.802μs  | ±2.98%  |
| ValidatorBench           | evaluate          | After              | 5    | 10  | 2.088mb  | 4.000μs   | ±2.26%  |
| ValidatorBench           | evaluate          | All                | 5    | 10  | 2.087mb  | 4.798μs   | ±2.13%  |
| ValidatorBench           | evaluate          | AllOf              | 5    | 10  | 2.088mb  | 3.400μs   | ±0.00%  |
...
| ValidatorBench           | evaluate          | BetweenExclusive   | 5    | 10  | 2.088mb  | 4.000μs   | ±0.00%  |
...
| ValidatorBench           | evaluate          | Domain             | 5    | 10  | 2.351mb  | 21.643μs  | ±1.68%  |
| ValidatorBench           | evaluate          | Each               | 5    | 10  | 2.087mb  | 5.024μs   | ±3.38%  |
| ValidatorBench           | evaluate          | EachKey            | 5    | 10  | 2.087mb  | 8.011μs   | ±1.59%  |
| ValidatorBench           | evaluate          | Email              | 5    | 10  | 2.265mb  | 19.042μs  | ±1.75%  |
...
| ValidatorBench           | evaluate          | Hetu               | 5    | 10  | 2.087mb  | 4.976μs   | ±3.60%  |
...
| ValidatorBench           | evaluate          | Image              | 5    | 10  | 9.865mb  | 166.249μs | ±3.03%  |
...
| ValidatorBench           | evaluate          | Luhn               | 5    | 10  | 2.087mb  | 3.001μs   | ±3.18%  |
| ValidatorBench           | evaluate          | MacAddress         | 5    | 10  | 2.087mb  | 1.000μs   | ±0.00%  |
| ValidatorBench           | evaluate          | Max                | 5    | 10  | 2.087mb  | 4.000μs   | ±1.51%  |
| ValidatorBench           | evaluate          | Min                | 5    | 10  | 2.087mb  | 4.000μs   | ±1.98%  |
| ValidatorBench           | evaluate          | Mimetype           | 5    | 10  | 9.867mb  | 171.756μs | ±2.62%  |
...
| ValidatorBench           | evaluate          | NfeAccessKey       | 5    | 10  | 2.087mb  | 4.200μs   | ±1.92%  |
| ValidatorBench           | evaluate          | Nif                | 5    | 10  | 2.087mb  | 1.200μs   | ±0.00%  |
| ValidatorBench           | evaluate          | Nip                | 5    | 10  | 2.087mb  | 2.000μs   | ±0.00%  |
| ValidatorBench           | evaluate          | NoneOf             | 5    | 10  | 2.087mb  | 3.201μs   | ±2.99%  |
...
| ValidatorBench           | evaluate          | OneOf              | 5    | 10  | 2.088mb  | 3.400μs   | ±2.38%  |
| ValidatorBench           | evaluate          | Pesel              | 5    | 10  | 2.087mb  | 1.600μs   | ±0.00%  |
| ValidatorBench           | evaluate          | Phone              | 5    | 10  | 2.895mb  | 33.064μs  | ±1.61%  |
...
| ValidatorBench           | evaluate          | Property           | 5    | 10  | 2.087mb  | 3.200μs   | ±2.81%  |
...
| ValidatorBench           | evaluate          | Size               | 5    | 10  | 2.090mb  | 7.207μs   | ±2.15%  |
...
| ValidatorBench           | evaluate          | Time               | 5    | 10  | 2.087mb  | 3.400μs   | ±2.74%  |
| ValidatorBench           | evaluate          | Tld                | 5    | 10  | 2.214mb  | 3.200μs   | ±2.47%  |
| ValidatorBench           | evaluate          | Trimmed            | 5    | 10  | 2.091mb  | 10.867μs  | ±2.93%  |
...
| ValidatorBench           | evaluate          | Url                | 5    | 10  | 2.531mb  | 36.481μs  | ±2.66%  |
| ValidatorBench           | evaluate          | Uuid               | 5    | 10  | 2.597mb  | 5.598μs   | ±1.82%  |
...
| CompositeValidatorsBench | isValidGrouped    | allOf(10)          | 50   | 5   | 2.469mb  | 5.783μs   | ±11.90% |
| CompositeValidatorsBench | isValidGrouped    | oneOf(10)          | 50   | 5   | 2.472mb  | 7.375μs   | ±3.85%  |
| CompositeValidatorsBench | isValidGrouped    | anyOf(10)          | 50   | 5   | 2.468mb  | 6.509μs   | ±4.96%  |
| CompositeValidatorsBench | isValidGrouped    | noneOf(10)         | 50   | 5   | 2.468mb  | 6.569μs   | ±7.90%  |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(10)   | 50   | 5   | 2.458mb  | 6.319μs   | ±8.90%  |
| CompositeValidatorsBench | isValidGrouped    | allOf(100)         | 50   | 5   | 2.513mb  | 8.911μs   | ±1.98%  |
| CompositeValidatorsBench | isValidGrouped    | oneOf(100)         | 50   | 5   | 2.516mb  | 10.770μs  | ±3.52%  |
| CompositeValidatorsBench | isValidGrouped    | anyOf(100)         | 50   | 5   | 2.512mb  | 11.451μs  | ±7.10%  |
| CompositeValidatorsBench | isValidGrouped    | noneOf(100)        | 50   | 5   | 2.512mb  | 9.897μs   | ±3.72%  |
| CompositeValidatorsBench | isValidGrouped    | shortCircuit(100)  | 50   | 5   | 2.502mb  | 10.845μs  | ±7.38%  |
| CompositeValidatorsBench | isValidArrayBased | all(10)            | 50   | 5   | 2.472mb  | 10.553μs  | ±4.80%  |
| CompositeValidatorsBench | isValidArrayBased | each(10)           | 50   | 5   | 2.473mb  | 19.635μs  | ±1.95%  |
| CompositeValidatorsBench | isValidArrayBased | all(100)           | 50   | 5   | 2.516mb  | 58.442μs  | ±2.33%  |
| CompositeValidatorsBench | isValidArrayBased | each(100)          | 50   | 5   | 2.517mb  | 143.611μs | ±4.78%  |
| CompositeValidatorsBench | isValidDomain     | no dots            | 50   | 5   | 2.627mb  | 7.914μs   | ±2.73%  |
| CompositeValidatorsBench | isValidDomain     | starts with "-"    | 50   | 5   | 2.627mb  | 8.003μs   | ±4.61%  |
| CompositeValidatorsBench | isValidDomain     | ends with "-"      | 50   | 5   | 2.627mb  | 7.776μs   | ±8.23%  |
| CompositeValidatorsBench | isValidDomain     | double "--"        | 50   | 5   | 2.627mb  | 7.656μs   | ±4.84%  |
